...
public class PaymentTestController {
    ...
    public ResponseEntity<UserPackage> simulatePayment(
        ...
        UserPackage userPackage = paymentTestService.simulatePayment(userId, packageId, price, description);
    ...
    public ResponseEntity<UserPackage> renewUserPackage(
        ...
        UserPackage userPackage = paymentTestService.renewUserPackage(userId, packageId, price, description);
        return ResponseEntity.ok(userPackage);
    }
}
