...
public class PaymentTestService {
    ...
    public UserPackage simulatePayment(Integer userId, Integer packageId, double price, String description) {
        LocalDateTime now = LocalDateTime.now(); // Add this line
        ...
        for (ServiceFeature feature : servicePackage.getFeatures()) {
            ...
            userBenefits.setUpdatedAt(now); // Use the defined 'now'
    ...
    public UserPackage renewUserPackage(Integer userId, Integer packageId, double price, String description) {
